...
if precache:GetBool() then
	...
	util.PrecacheModel("models/knyaje pack/sso_politepeople/sso_politepeople.mdl") -- Playermodels
	util.PrecacheModel("models/monolithservers/mpd/male_02.mdl")
	util.PrecacheModel("models/monolithservers/mpd/male_03.mdl")
	util.PrecacheModel("models/monolithservers/mpd/male_04_2.mdl")
	...
	util.PrecacheModel("models/bydistac/weapons/w_shot_m3juper90.mdl") -- Weapons
	...
	util.PrecacheModel("models/pwb/weapons/w_m134.mdl")
